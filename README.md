...
| **[ft_lrint](https://github.com/TeomanDeniz/ft_math/blob/main/Rounding_Remainder/ft_lrint.c)** **[ft_lrintf](https://github.com/TeomanDeniz/ft_math/blob/main/Rounding_Remainder/ft_lrintf.c)**                     | `double` x                               | Roundoff the floating-point `x` to an integer                       |

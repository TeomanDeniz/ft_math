...
| **[ft_relu](https://github.com/TeomanDeniz/ft_math/blob/main/Neural_Network/ft_relu.c)**                            | `double` x                                     | "The Rectified Linear Unit" Returns `0` if `x` is negative              |
| **[ft_leakyrelu](https://github.com/TeomanDeniz/ft_math/blob/main/Neural_Network/ft_leakyrelu.c)**                  | `double` x, `double` aplha                     | ReLU, But has a small slope for negative values instead of a flat slope |
| **[ft_elu](https://github.com/TeomanDeniz/ft_math/blob/main/Neural_Network/ft_elu.c)**                              | `double` x, `double` aplha                     | "Exponential Linear Unit" Determines the slope for negative input       |
| **[ft_prelu](https://github.com/TeomanDeniz/ft_math/blob/main/Neural_Network/ft_prelu.c)**                          | `double` x, `double` aplha                     | ReLU, But has a small slope for negative values instead of a flat slope |
| **[ft_mish](https://github.com/TeomanDeniz/ft_math/blob/main/Neural_Network/ft_mish.c)**                            | `double` x                                     | Hyperbolic tangent function, and `softplus` is the smooth approximation |
| **[ft_softmax](https://github.com/TeomanDeniz/ft_math/blob/main/Neural_Network/ft_softmax.c)**                      | `double *` x, `int` size                       | Normalizes the input array `x` by exponentiating each element           |
| **[ft_softmin](https://github.com/TeomanDeniz/ft_math/blob/main/Neural_Network/ft_softmin.c)**                      | `double *` x, `int` size, `double` alpha       | Aka: softmax(-`x`)                                                      |
| **[ft_softmedian](https://github.com/TeomanDeniz/ft_math/blob/main/Neural_Network/ft_softmedian.c)**                | `double *` x, `int` size, `double` alpha       | Defined as the weighted average of the elements in a vector `x`         |
